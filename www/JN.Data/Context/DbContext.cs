...
namespace JN.Data
{
    ...
    public partial class SysDbContext : FrameworkContext
    {
        ...
        public SysDbContext()
            : base(
                  ConfigurationManager.AppSettings["HaveEncrypt"].ToLower() == "false" ? ConfigurationManager.AppSettings["ConnectionString"] :
                  DESEncrypt.Decrypt(ConfigurationManager.AppSettings["ConnectionString"], ConfigurationManager.AppSettings["EncryptKey"])
                  )
        {
